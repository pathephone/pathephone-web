...
import type { TShareAlbumPageScreen } from "type/state";
...
export const ShareAlbumPageContainer = () => {
  ...
  const hasLoader = screen === ("LOADING": TShareAlbumPageScreen);

  const hasDropZone = screen === ("SELECTING_FILES": TShareAlbumPageScreen);

  const hasEditor = screen === ("EDITING_ALBUM": TShareAlbumPageScreen);
